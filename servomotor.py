...
try:                 
    while True:      #iniciamos un loop infinito
        ...
        p.ChangeDutyCycle(3)    #Enviamos un pulso del 4.5% para girar el servo hacia la izquierda
        time.sleep(1)           #pausa de medio segundo
        p.ChangeDutyCycle(7)   #Enviamos un pulso del 10.5% para girar el servo hacia la derecha
        time.sleep(1)           #pausa de medio segundo
        p.ChangeDutyCycle(11)    #Enviamos un pulso del 7.5% para centrar el servo de nuevo
        time.sleep(1)           #pausa de medio segundo
